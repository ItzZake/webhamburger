...
<head>
    ...
    <title>Coach Dashboard - Power Gym</title>
    ...
    <script src="CoachDashboard.js" defer></script>
</head>
<body>
    <!-- Mobile Menu Button -->
    ...
    <div id="workout-preview-modal" class="modal">
        <div class="modal-content" style="max-width: 900px; max-height: 90vh; overflow-y: auto;">
            <div class="modal-header">
                <h2 id="preview-title">Workout Preview</h2>
                <button class="modal-close" onclick="closeWorkoutPreview()">&times;</button>
            </div>
            <div class="modal-body" id="workout-preview-body">
                <!-- Preview content -->
            </div>
            <div class="modal-footer" style="padding: 20px; border-top: 1px solid var(--border-color); display: flex; gap: 10px; justify-content: flex-end;">
                <button class="action-btn secondary" onclick="closeWorkoutPreview()">Cancel</button>
                <button class="action-btn" id="confirm-workout-btn">Confirm & Save</button>
            </div>
        </div>
    </div>
</body>
